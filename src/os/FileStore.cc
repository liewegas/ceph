...
FileStore::FileStore(const std::string &base, const std::string &jdev, osflagbits_t flags, const char *name, bool do_update) :
  ...
  ondisk_finisher(g_ceph_context, "FileStore::ondisk_finisher"),
  lock("FileStore::lock"),
  force_sync(false), 
  sync_entry_timeo_lock("sync_entry_timeo_lock"),
  timer(g_ceph_context, sync_entry_timeo_lock, "FileStore::timer"),
  ...
  op_finisher(g_ceph_context, "FileStore::op_finisher"),
