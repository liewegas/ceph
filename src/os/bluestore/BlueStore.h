...
enum {
  ...
  l_bluestore_kv_synct_lat,
  l_bluestore_kv_finisher_lat,
  l_bluestore_kv_finisher_deferred_lat,
  l_bluestore_kv_reap_lat,
  l_bluestore_kv_lat,
  ...
  l_bluestore_commit_finisher_lat,
  l_bluestore_commit_throttle_lat,
  l_bluestore_txc_finish_lat,
