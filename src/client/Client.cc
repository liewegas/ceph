...
Client::Client(Messenger *m, MonClient *mc)
  : Dispatcher(m->cct),
    logger(NULL),
    m_command_hook(this),
    timer(m->cct, client_lock, "Client::timer"),
    ...
    getgroups_cb(NULL),
    async_ino_invalidator(m->cct, "Client::async_ino_invalidator"),
    async_dentry_invalidator(m->cct, "Client::async_dentry_invalidator"),
    interrupt_finisher(m->cct, "Client::interrupt_finisher"),
    remount_finisher(m->cct, "Client::remount_finisher"),
    objecter_finisher(m->cct, "Client::Objecter_finisher"),
    tick_event(NULL),
