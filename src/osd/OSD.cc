...
OSDService::OSDService(OSD *osd) :
  ...
  agent_timer(osd->client_messenger->cct, agent_timer_lock,
	      "OSDService::agent_timer"),
  objecter(new Objecter(osd->client_messenger->cct, osd->objecter_messenger, osd->monc, NULL, 0, 0)),
  objecter_finisher(osd->client_messenger->cct, "OSDService::objecter_finisher"),
  watch_lock("OSD::watch_lock"),
  watch_timer(osd->client_messenger->cct, watch_lock, "OSDService::watch_tiemr"),
  next_notif_id(0),
  backfill_request_lock("OSDService::backfill_request_lock"),
  backfill_request_timer(cct, backfill_request_lock,
			 "OSDService::backfill_request_timer", false),
  last_tid(0),
  tid_lock("OSDService::tid_lock"),
  reserver_finisher(cct, "OSDService::reserver_finisher"),
...
OSD::OSD(CephContext *cct_, ObjectStore *store_,
  ...
  tick_timer(cct, osd_lock, "OSD::tick_timer"),
